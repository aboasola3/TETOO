...
local function list_chats(msg)
  ...
  if hash then
    ...
    local text = ' الـ✮๋͜͡‏ٰ̲ـِــــ๋͜͡ــردود هـﮧ௸ْْـّٰ̐ہٰٰـــ๋͜͡ـہٰٰـيـــ๋͜͡ــا❇️: ️\n\n'
    for i=1, #names do
      text = text..'® '..names[i]..'\n'
    end
    return text
...
local function save_value(msg, name, value)
  ...
  if hash then
    ...
    return '('..name..')\n تـﮧ௸ْْـّٰ̐ہٰٰـــ๋͜͡ـہٰٰم اضـ✮๋͜͡‏ٰ̲ـِــــ๋͜͡ــافـــ๋͜͡ـہٰٰه الﮧ௸ْْـّٰ̐ہٰٰرد✅️ '
  end
end
local function del_value(msg, name)
  ...
  if hash then
    ...
    return '('..name..')\n  تـﮧ௸ْْـّٰ̐ہٰٰـــ๋͜͡ـہٰٰم حــــ๋͜͡ـہٰٰـذف الﮧ௸ْْـّٰ̐ہٰٰرد❎️ ' 
  end
end
